...
public class Tc0016_ForgotPassword_PZ_VerificationCode extends ProjectWrapp{
  
  @BeforeClass(groups={"common"})
  public void setDatag() {
	  testCaseName="Forgot Password";
	  testDescription="Forgot_Password_Mail_PZ_VerficationCode_Password";
	  browserName="Chrome"; 
	  category="Smoke";
	  authors="MuthuMuniyandi";
	  dataSheetName="MyHTestData.xlsx";
	  testKeyword="Forgot_Password_Mail_PZ_VerficationCode_Password";
	}	
